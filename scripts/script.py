...
GDP_average_descending = GDP_descending.sort_values('GDP', ascending = Fals, ignore_index  = True)
...
fig = plt.figure(figsize = (12,12))
ax = sns.linplot(data = df, x = 'Year', y = 'GDP', hue = 'Country')
...
for country in countries:
	df_temp = df[df.Country == countries]
...
for country in countries:
	...
	ax2 = ax.twinx()
	sns.regplot(data = df_temp, x = 'Year', y = 'Life expectancy at birth (years)', label = 'Life Expectancy')
